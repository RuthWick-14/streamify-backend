...
const getUserChannelProfile = asyncHandler(async(req, res) => {
    ...
    const channel = await User.aggregate([
        ...
        //how many subscribers does they have ?
        {
            $lookup: {
                from: "Subscription",
                localField: "_id",
        ...
        //how many subscribed by the subscriber ?
        {
            $lookup: "Subscription",
            localField: "_id",
        ...
        // Counting number of subscriber and subscribed channel 
        {
            $addFields: {
                subscribersCount: {
                    $size: "$subscribers"
        ...
        // projection of fields in frontend
        {
            $project: {
                fullName: 1,
                username: 1,
